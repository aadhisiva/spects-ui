...
export const PhcoTable: React.FC = () => {
    ...
    const columns: ColumnsType<DataType> = [
        ...
        },
        {
            ...
            sortOrder: sortedInfo.columnKey === 'health_facility' ? sortedInfo.order : null,
            ellipsis: true,
        },
        {
                            ...
                            <div className={styles.selecttypes}>
                                ...
                                >
                                    {(phcoSelected || [])?.map((obj: any, i) => (
                                        <Select.Option key={String(i)} value={`${obj.health_facility}`}>{obj.health_facility}</Select.Option>
                                    ))}
                                </Select>
                            </div>
                        </Col>
